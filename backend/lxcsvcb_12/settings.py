"""
Django settings for lxcsvcb_12 project.
...
WSGI_APPLICATION = 'lxcsvcb_12.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lxcsvcb_12 API",
    "DESCRIPTION": "API documentation for lxcsvcb_12 App",
    "VERSION": "v1",
}
